 ...
 * @author ran
 */
public class ManajemenDosen extends ManajemenMenu {
    ...
    public ManajemenDosen(home_admin home, dosen model) {
        super(home);
        this.ha = home;
...
//    public ManajemenDosen(home_admin home, app.model.dosen m_dosen) {
//        
//    }
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ha.getBaris() < 0) {
                ...
                try {
                    ...
                    Logger.getLogger(ManajemenDosen.class.getName()).log(Level.SEVERE, null, ex);
                }
                ha.showCard("tb_dosen");
